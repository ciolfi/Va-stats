            ...
            <div className={styles.studentapplicationform}>
                <h2>Student Application Form &rarr;</h2><br />
                    <form action='/api/studentapplication' method='post' onSubmit={() => handleSubmit()}>
                        ...
                        <label htmlFor='courses'>What courses are you interested in? Go to the <a href="/courses">Courses page</a> for a list of available courses.<span className={styles.requiredelement}>&#42;</span></label>
