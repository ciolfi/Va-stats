...
export default function Page() {
  ...
  const pythonSummary = "The Python course is an exciting...";
  const cSummary = "The C course is an exciting...";
  const cplusplusSummary = "The C++ course is an exciting...";
  const ccaSummary = "The CCA course is an exciting...";
  const phpSummary = "The PHP course is an exciting...";
  const htmlSummary = "The HTML course is an exciting...";
  const mobtechSummary = "The Mobile Technology course is an exciting...";
  const cssSummary = "The CSS course is an exciting...";
  ...
  const updateChoices = (e) => {
    ...
    if (name === 'first_choice') {
      ...
      /*----------- COURSE CHOICE SUMMARIES ITEM ----------*/
      alert("First choice summary is: " + getSummaries(value));

    } else if (name === 'second_choice') {
      setOption2(value);

      /*----------- COURSE CHOICE SUMMARIES ITEM ----------*/
      alert("Second choice summary is: " + getSummaries(value));
      ...
      /*----------- COURSE CHOICE SUMMARIES ITEM ----------*/ 
      alert("Third choice summary is: " + getSummaries(value));
