...
export default async function handler(req, res) {
  ...
  try {
    // ORIG VERSION
    const query = "SELECT id, email, name, phone_number, gender, age, edu_qualifications, courses, location, objectives, vision_impairment, usable_vision, total_vision_loss, source, registration_date FROM vastudents";
