...
export default async function handler(req, res) {
  try {
    ...
    const data = await executeQuery({
      ...
      values: [body.email, body.firstname, body.lastname, body.designation, body.joindate, body.mobilenumber, body.workbase, body.supervisor, body.natureofjob, body.visualacuity, body.trainingprogram1, body.trainingprogram2, body.trainingprogram3, body.role, body.isactive, body.action],
    });
