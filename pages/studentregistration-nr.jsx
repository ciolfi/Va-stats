                  ...
                  <table id="formtable" className={styles.regtable} role="presentation" style={{ fontWeight: "500" }}>
                    <tbody>
                      ...
                      <tr className={styles.regrow}>
                        ...
                        <td className={styles.inputtd}>
                          <select name="country" id="country" className={styles.reginput} onChange={(e) => updateStateOptions(e)} role="presentation" autoComplete="off">
                            <option></option>
                            {countriesOptions}
                          </select>
                        </td>
                      ...
                      <tr className={styles.regrow}>
                        ...
                        <td className={styles.inputtd}>
                          <select name="state" id="state" className={styles.reginput} role="presentation" autoComplete="off"
                          >
                            <option></option>
                            {stateOptions}
                          </select>
                  ...
                  <fieldset className={styles.fdsetlearning}>
                    ...
                    <table className={styles.tblchoosecourses} role="presentation">
                      ...
                      <tr>
                        ...
                        <td className={styles.inputtd}>
                          <select name="first_choice" id="first_choice" className={styles.reginput} onChange={(e) => updateChoices(e)} ref={refFirstChoice} role="presentation" autoComplete="off"
                          >
                            <option></option>
                            {courseOptions1}
