                  ...
                  <table className={styles.regtable} role="presentation" style={{ fontWeight: "500" }}>
                    ...
                    <tbody>
                      <tr className={styles.regrow}>
                        ...
                        <td className={styles.inputtd}><input type="email" autofocus id="email" name="email" required className={styles.reginput} /></td>
                      </tr>
                      <tr className={styles.regrow}>
                        <td className={styles.inputlabel}>
                          <label htmlFor="name">
                      ...
                      <tr className={styles.regrow}>
                        ...
                        <td className={styles.inputtd}><input type="tel" id="alt_ph_num" name="alt_ph_num" className={styles.reginput} /></td>
                      </tr>
                      <tr className={styles.regrow}>
                        <td className={styles.inputlabel}>
                          <label htmlFor="city">
                        ...
                        <td className={styles.inputtd}><input type="text" id="city" name="city" className={styles.reginput} /></td>
                      </tr>
                      <tr className={styles.regrow}>
                        <td className={styles.inputlabel}>
                          <label htmlFor="state">
                        ...
                        <td className={styles.inputtd}><input type="text" id="state" name="state" className={styles.reginput} /></td>
                      </tr>
                      ...
                      <tr className={styles.regrow}>
                        ...
                        <td className={styles.inputtd}>
                          ...
                          <select name="gender" id="gender" className={styles.txtboxdropdown} onSelectionChange={setSelectedGender}>
                      ...
                      <tr className={styles.regrow}>
                        ...
                        <td className={styles.inputtd}>
                          <input type="datetime-local" id="age" name="age" className={styles.reginput} />
                        </td>
                      </tr>
                      ...
                      <tr className={styles.regrow}>
                        ...
                        <td className={styles.inputtd}><input type="text" id="edu_qualifications" name="edu_qualifications" required className={styles.reginput}
                      ...
                      <tr className={styles.regrow}>
                        ...
                        <td className={styles.inputtd}>
                          ...
                          <select name="employment_status" id="employment_status" className={styles.txtboxdropdown} onSelectionChange={setSelectedEmpStatus}>
                      ...
                      <tr className={styles.regrow}>
                        ...
                        <td className={styles.inputtd}><input type="text" id="objectives" name="objectives" required className={styles.reginput}
                  ...
                  <table className={styles.tblmisc} role="presentation">
                    <tr className={styles.regrow}>
                      ...
                      <td className={styles.inputtd}>
                        ...
                        <select name="visual_acuity" id="visual_acuity" className={styles.txtboxdropdown} onSelectionChange={setSelectedVision}>
                    ...
                    <tr className={styles.regrow}>
                      ...
                      <td className={styles.inputtd}>
                        <textarea name="impairment_history" id="impairment_history" placeholder='300-char max' className={styles.regtextarea} rows="10" cols="20">
                        </textarea>
                      </td>
                    </tr>
                    <tr className={styles.regrow}>
