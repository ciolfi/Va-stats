...
export default function Page() {
  ...
  /*-------------------------- EDUCATION COMBO BOX: DYNAMIC TEXTBOX ------------------*/
  // value=dropdown selection; setEducationValue=constant referenced in onChange event

  // EDUCATION-OTHER (ORIGINAL CODE)
  // const [handleEducationOther, setEducationOther] = React.useState(new Set(["Below 10th standard"]));
  // const [value, setEducationValue] = React.useState(new Set(["Below 10th standard"]));
  // const selectedValueEducation = React.useMemo(
  //   () => Array.from(value).join(", ").replaceAll("_", " "),
  //   [value]
  // );

  /*----------------- VANILLA JS EVENT LISTENERS BEGINS --------------------*/
  // Education combo box: Dynamically-generated 'Other' row: Submit button
  // IDs: dyn button = newboxbtn; Educ dropdown = edu_qualifications

  /*--------------------- VANILLA JS EVENT LISTENERS ENDS ----------------------*/
  // const resetEdValue = (e) => {
  //   console.log("Entered RESETEDVALUE FCT");
  //   const [sentvalue, setNewEdValue] = () => React.useState();
  //   var parentDiv = document.getElementById("newinputtd");
  //   if (parentDiv) {
  //     console.log("Entered IF PARENT DIV block");
  //     var inputVal = parseInt(parentDiv.childNodes[0].dataset.value);
  //     var newtextbtnclick = document.getElementById("newboxbtn").onclick();
  //     if ((inputVal != null) && (newtextbtnclick)) {
  //       console.log("Entered btn click block");
  //       document.getElementById("edu_qualifications").value = inputVal;
  //       console.log("New value sent to edu_qualifications");
  //     }
  //   }
  // }


  /*------------ EDUCATION DYNAMIC BLOCK: LISTENER BLOCK -----------*/
  const [edvalue, setEducationValue] = React.useState(new Set(["Below 10th standard"]));
  console.log("Education was changed to " + edvalue);
  ...
  if (edvalue == 'Other') {
    ...
    /*----------- 'EDUCATION-OTHER' TEXTBOX ROW BEGINS ------------*/
      ...
      //   // newedval.setState({text: 'This is my new text!'});
      //   newedval.setState.value({ text: 'This is my new text!' });
      // }

      // newedrow.innerHTML = "<td><label>Other Education</label><input id='newtextbox' type='text' /><button id='newboxbtn' type='button' onClick='return this.parentNode.remove(); reset_edqual();'>Submit</button></td>";
      // newedrow.innerHTML = "<td className='{styles.inputlabel}'><label htmlFor='edu_qualifications'>Other Ed</label><span className={styles.requiredelement}>&#42;</span></td><td className={styles.inputtd}><input id='newtextbox' /></td><button id='newboxbtn' type='button' onClick='{document.getElementById(newtextbox).value => {resetEdValue}}; return this.parentNode.remove();'>Submit</button></td>";

      // newedrow.innerHTML = "<td className='{styles.inputlabel}'><label htmlFor='edu_qualifications'>Other Ed</label><span className={styles.requiredelement}>&#42;</span></td><td className={styles.inputtd}><input id='newtextbox' /></td><button id='newboxbtn' type='button' onClick='{(e) => resetEdValue()}; return this.parentNode.remove();'>Submit</button></td>";
      newedrow.innerHTML = "<td className='{styles.inputlabel}'><label htmlFor='edu_qualifications'>Other Ed</label><span className={styles.requiredelement}>&#42;</span></td><td className={styles.inputtd}><input id='newtextbox' /></td><button id='newboxbtn' type='button' onClick='return this.parentNode.remove();'>Submit</button></td>";

      // Sample constant call - SET UP LISTENER HERE?
      // {(e) => { setEducationValue(e.target.value); }}

      document.getElementById("formtable").appendChild(newedrow);

      // Change element text; place LISTENER HERE
      // function resetEdValue() {
      //   newedval.value = "New value!";
      // }

      const boxbtn = document.getElementById("newboxbtn");
      var newedval = document.getElementById("edu_qualifications");
      
      boxbtn.addEventListener("click", function (e) {        
        console.log("ENTERED LISTENER");  
        var newboxtext = document.getElementById("newtextbox");     
        var newopt = document.createElement("option");
        console.log("NEWOPTCREATED: "+newopt);
        newopt.value = newboxtext.value;
        console.log("NEWOPTVALUE: "+newopt.value);
        var visibleval = newedval.prepend(newopt);   
        console.log("VISIBLEVALDECLARED: "+visibleval);    
        newedval.value = visibleval;
        console.log("VISIBLEVAL: "+visibleval);
        // newedval[0] = new Option(text, newbox.value);
        // newedval.value = newedval[0];
        // newedval.dispatchEvent(new Event('change'));
        // var [value, setEducationValue] = React.useState(new Set(["Below 10th standard"]));
      });
    }
    /*----------- 'EDUCATION-OTHER' TEXTBOX ROW ENDS ------------*/
                      ...
                      <tbody>
                        ...
                        <tr className={styles.regrow}>
                          ...
                          <td className={styles.inputtd}>
                            ...
                            {/* MUI autocomplete combo box component */}
                            {/* <Autocomplete
                              disablePortal
                              id="combo-box-demo"
                              options={top100Films}
